Feature: Nopcommerce Registration
  ...
  Background: I am on Nopcommerce Registration page
    ...
    Scenario outline: I should not able to register with invalid data on mandatory field (*) of registration page
      ...
      Scenario:    I should be able to selcect any radio button from Gender Label of Your Personal Details section
        ...
        Scenario outline : I should be able to select Day,Month and Year from drop down list of Date of birth field
          Given     I am Date of Birth field oe Your personal Detai section
          ...
          Scenario: I should be able able to cheack and uncheck the Newsletter box on  options section
            Given   I am on Newsletter label on Option
            When    I click on Newsletter checkbox
            And     I again click on Newsletter Checkbox
            Then    Iwas able to check and uncheck the box next tp Newsletter label

         Scenario:  I should be able to gerister with valid mandatory (*)field data on registration page
