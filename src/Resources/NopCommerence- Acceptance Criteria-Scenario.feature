Feature: Demo Nopcommerce's topmenu acceptance criteria
  ...
  As auser, i would like to check acceptance criteria of Nopcommerce topmenu

  Background: User is on given URL
    When      User type URL https://demo.nopcommerence.com
  ...
  Scenario:   Verify that user can navigate to Books category
    ...
    Then      User ia navigated to Books Category page
